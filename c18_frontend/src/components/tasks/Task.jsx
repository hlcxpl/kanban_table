...
const Task = ({ task, provided }) => {
    const { company, job, description, priority, deadline, image, alt, tags } = task;
    ...
    return (
        ...
        >
            ...
            <div className="w-full flex items-start flex-col gap-0">
                <span className="text-[15.5px] font-medium text-[#555]">{company}</span>
                <span className="text-[14.5px] font-medium text-[#555]">{job}</span>
